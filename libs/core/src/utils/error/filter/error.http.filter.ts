...
import { DebuggerService } from '@core/debugger/service/debugger.service';
import { IMessage } from '@core/message/message.interface';
...
export class ErrorHttpFilter implements ExceptionFilter {
  ...
  async catch(exception: HttpException, host: ArgumentsHost): Promise<void> {
    ...
    if (
      ...
      const message = await this.messageService.get(`http.${statusHttp}`, {
        customLanguages,
      });
